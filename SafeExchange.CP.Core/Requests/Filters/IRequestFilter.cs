...
namespace SafeExchange.CP.Core.Filters
{
    ...
    public interface IRequestFilter
    {
        ...
        /// <returns></returns>
        public ValueTask<(bool shouldReturn, HttpResponseData? response)> GetFilterResultAsync(HttpRequestData req, ClaimsPrincipal principal, SafeExchangeCPDbContext dbContext);
    }
}
